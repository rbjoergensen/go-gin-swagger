...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_swaggo_swag_example_celler_httputil.HTTPError"
                        }
                    },
                    "404": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main_controller.Message"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "github_com_swaggo_swag_example_celler_httputil.HTTPError": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
